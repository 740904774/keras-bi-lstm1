...
#                           打印日志的时间  打印日志的级别名称  打印日志信息  日志级别

import codecs
import jieba
import datetime
start = datetime.datetime.now()
datapaths="C:\\Users\\Administrator\\Desktop\\研一下课程\\CCF竞赛\\data\\"
...
import pandas as pd
with open(datapaths+"nCoV_100k_train.labled1.csv",encoding="utf-8") as f:
    df = pd.read_csv(f)
df1 = df['微博中文内容']
df2 = df['情感倾向']
row = len(df1)
...
with codecs.open(r"C:\Users\Administrator\Desktop\研一下课程\bilstm\cnn_lstm_cnnlstm_textcnn_bilstm\vocabulary.txt","w","utf-8") as f:
...
pretrainpath=r"C:\Users\Administrator\Desktop\研一下课程\bilstm\cnn_lstm_cnnlstm_textcnn_bilstm\\"
...
'''
    ...
    第二个数字表示维度大小
'''
with codecs.open(pretrainpath+"sgns.weibo.bigram","r","utf-8") as f:
    #line=f.readlines()
    line=f.readline()
